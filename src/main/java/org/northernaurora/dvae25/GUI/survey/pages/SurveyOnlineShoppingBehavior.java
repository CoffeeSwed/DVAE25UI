...
public class SurveyOnlineShoppingBehavior extends SurveyPage implements ActionListener {
    private static final Logger logger = LogManager.getLogger(SurveyOnlineShoppingBehavior.class);
    ...
    public void init() {
        super.init();
        this.nextPage = new SurveyOnlineSocialMediaBehavior();
